...
var Slider = React7.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React7.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React7.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React7.useRef(values);
...
var SliderHorizontal = React7.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const [slider, setSlider] = React7.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React7.useRef(void 0);
...
var SliderVertical = React7.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const sliderRef = React7.useRef(null);
...
var SliderImpl = React7.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React7.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React7.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React7.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection(props.__scopeSlider);
    const [thumb, setThumb] = React7.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index = React7.useMemo(
...
var SliderThumbImpl = React7.forwardRef(
  (props, forwardedRef) => {
...
var SliderBubbleInput = React7.forwardRef(
